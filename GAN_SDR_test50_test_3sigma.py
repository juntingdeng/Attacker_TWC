...
if __name__ == "__main__":
    ...
    print("h_sigma_load.shape:{}", h_sigma_load.shape)
    hi=0
    for SDRlabel in range(start, start+nSDR):
        ...
        path = "./checkpoint2/gan/gan_poly_ray_SDR_normAll_nosnrclf_bn_dup/snr{}/seed{}/bs{}/ckp/".format(SNR, seed, batch_size)
        ...
        for batch_idx, (data, labels) in enumerate(datasetLoader):
            ...
            # h_real = h_sigma_load[hi][0][:batch_size]
            # h_imag = h_sigma_load[hi][1][:batch_size]
            # hi+=1
            h_comp=[h_real, h_imag]
